...
<head>
    ...
    <!-- StyleSheets  -->
    <link rel="stylesheet" href="./admin/assets/css/dashlite.css?ver=3.2.3">
    <link id="skin-default" rel="stylesheet" href="./admin/assets/css/theme.css?ver=3.2.3">
</head>
                        ...
                        <div class="nk-block nk-block-middle nk-auth-body">
                            <div class="brand-logo pb-5">
                                <a href="html/index.html" class="logo-link">
                                    <img class="logo-light logo-img logo-img-lg" src="./admin/images/logo.png" srcset="./admin/images/logo2x.png 2x" alt="logo">
                                    <img class="logo-dark logo-img logo-img-lg" src="./admin/images/logo-dark.png" srcset="./admin/images/logo-dark2x.png 2x" alt="logo-dark">
                                </a>
                            </div>
                        ...
                        <div class="slider-wrap w-100 w-max-550px p-3 p-sm-5 m-auto">
                            <div class="slider-init" data-slick='{"dots":true, "arrows":false}'>
                                <div class="slider-item">
                                    <div class="nk-feature nk-feature-center">
                                        <div class="nk-feature-img">
                                            <img class="round" src="./admin/images/slides/promo-a.png" srcset="./admin/images/slides/promo-a2x.png 2x" alt="">
                                        </div>
                                ...
                                <div class="slider-item">
                                    <div class="nk-feature nk-feature-center">
                                        <div class="nk-feature-img">
                                            <img class="round" src="./admin/images/slides/promo-b.png" srcset="./admin/images/slides/promo-b2x.png 2x" alt="">
                                        </div>
                                        <div class="nk-feature-content py-4 p-sm-5">
                                            <h4>Dashlite</h4>
                                            <p>You can start to create your products easily with its user-friendly design & most completed responsive layout.</p>
                                ...
                                <div class="slider-item">
                                    <div class="nk-feature nk-feature-center">
                                        <div class="nk-feature-img">
                                            <img class="round" src="./admin/images/slides/promo-c.png" srcset="./admin/images/slides/promo-c2x.png 2x" alt="">
                                        </div>
                                        <div class="nk-feature-content py-4 p-sm-5">
                                            <h4>Dashlite</h4>
                                            <p>You can start to create your products easily with its user-friendly design & most completed responsive layout.</p>
